...
#finished
	...
	$installCommandHead_skipbroken_nogpgcheck  createrepo cairo-dock thunderbird gimp evince p7zip-plugins p7zip-full p7zip-rar rar unrar bzip2 unzip zip *zip* file file* libtool docker docker* mtr traceroute network* tmux* screen* fbida fbida* shellinabox pigz pbzip2 mgzip 
