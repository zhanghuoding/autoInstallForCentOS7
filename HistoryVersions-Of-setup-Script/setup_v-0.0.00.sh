...
#ready
	...
	$installCommandHead_skipbroken_nogpgcheck  wget curl axel gcc gcc-++ g++ ntfs-3g
	initSystemTime
...
#install PDF reader
	...
	$installCommandHead_skipbroken_nogpgcheck  gcc gcc-++ g++ ntfs-3g adb stardict fuse-ntfs-3g dict valgrind valgrin*

	$installCommandHead_skipbroken_nogpgcheck  gnome-utils gnome-system-monitor axel wget filezilla docky azureus

	$installCommandHead_skipbroken_nogpgcheck  deluge shutter starditc supertux zsnes acroread kdevelop anjuta netbeans
	...
	$installCommandHead_skipbroken_nogpgcheck  cscope lnsight flawfinder crosstool indent flashgot wxwidgets xulrunner.i686

	$installCommandHead_skipbroken_nogpgcheck  libXtst.i686 libjpeg* libjpeg libpng libpng* freetype freetype*

	$installCommandHead_skipbroken_nogpgcheck  openssh-server openssh-client openssh samba telnet-server

	$installCommandHead_skipbroken_nogpgcheck  telnet ssh xinetd fcitx fcitx* makehuman darktable entangle hugin python python3

	$installCommandHead_skipbroken_nogpgcheck  python-pip sublime-text xournal tree dia umbrello umlgraph gcc-c++ gcc-c++*

	$installCommandHead_skipbroken_nogpgcheck  gcc gcc-++ g++ ntfs-3g bluefish juffed anjuta asymptote audacious azureus boxes

	$installCommandHead_skipbroken_nogpgcheck  brasero cmyktool codeblocks darkable deluge devhelp dia docky emacs codeblocks*

	$installCommandHead_skipbroken_nogpgcheck  empathy evolution feh filezilla fontforge umbrello  pinentry-gui ncurses dialog

	$installCommandHead_skipbroken_nogpgcheck  fontmanager geary gedit gnomebaker gnusmallta gnu gparted gpick gthumb
